...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) { 
  ...
  if (led_state.num_lock) {
        rgb_matrix_set_color(48, state_rgb.r, state_rgb.g, state_rgb.b);
  }
  if (led_state.caps_lock || is_caps_word_on()) {
        rgb_matrix_set_color(49, state_rgb.r, state_rgb.g, state_rgb.b);
  }
  if (led_state.scroll_lock) {
        rgb_matrix_set_color(50, state_rgb.r, state_rgb.g, state_rgb.b);
  }
